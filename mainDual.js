...
const UP_HYSTERESIS = 1
const DOWN_HYSTERESIS = 1
    ...
    async function fetchOHLCV() {
        ...
        const deriveMA100 = () => {
            ...
            const deriveTrend = async () => {      
                ...
                console.log(`HYSTERESIS DOWN : ${DOWN_HYSTERESIS}`)
                console.log("")
                ...
                fs.readFile('./database.json', 'utf8', (err, data) => {
                    ...
                    // add a new record
                        databases.push({
                            ...
                            HysteresisDown: DOWN_HYSTERESIS,
                            mode: 'main',
                    });
                ...
                const orderTriggerControl = async () => {   
                    ...
                    //if( trendVector_BTCUP_ALMA_500 < UP_HYSTERESIS && trendVector_BTCUP_ALMA_500 > DOWN_HYSTERESIS ) {  }
                    
                    if( trendVector_BTCUP_ALMA_500 < DOWN_HYSTERESIS ) {  //BTCUP ==> BTCDOWN
